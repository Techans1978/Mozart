...
$nome_fantasia = $registro['nome_fantasia'];
    ...
    if ($stmt_update->execute()) {
        header("Location: ../includes/ok-sucesso.html?mensagem=" . urlencode("Dados atualizados com sucesso!"));
        exit();
    } else {
...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-3 text-center">
      <a href="../index.html">
        <img src="../images/grupo-abc-logo.png" alt="Grupo ABC" width="150px" height="auto">
      </a>
    </div>
    <div class="col-md-9">
      <br>
