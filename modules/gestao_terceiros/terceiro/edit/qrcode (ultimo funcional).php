...
$empresa = $usuario['NOME_FANTASIA']; // <- Corrigido para usar o que veio do banco
...
if (!file_exists($caminho_qr)) {
    ...
    // Centraliza o nome
$box_nome = imagettfbbox(16, 0, $fonte, $nome);
$largura_texto_nome = $box_nome[2] - $box_nome[0];
$x_nome = ($largura - $largura_texto_nome) / 2;
imagettftext($img_final, 16, 0, $x_nome, $altura + 25, $preto, $fonte, $nome);

// Centraliza a empresa
$empresa_upper = strtoupper($empresa);
...
imagettftext($img_final, 12, 0, $x_empresa, $altura + 50, $preto, $fonte, $empresa_upper);
